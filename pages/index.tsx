...
export default function IndexPage() {
  ...
  return (
    <Container className={classes.wrapper}>
      ...
      >
        Download latest (0.5.1) &nbsp;:&nbsp;
        <a href="https://github.com/gam3dotdev/website/releases/latest/download/Charaday-Setup-0.5.1.exe">
          Windows
        </a>
        &nbsp;|&nbsp;
        <a href="https://github.com/gam3dotdev/website/releases/latest/download/Charaday-0.5.1.dmg">
          Intel MacOS
        </a>
        &nbsp;|&nbsp;
        <a href="https://github.com/gam3dotdev/website/releases/latest/download/Charaday-0.5.1-arm64.dmg">
