    ...
    <Container size="sm" className={classes.wrapper}>
      ...
      <Accordion variant="separated">
        <Accordion.Item className={classes.item} value="1">
          ...
          <Accordion.Panel>
            This app is a convenience to make editing Faraday characters easier.
            For example, if you have characters <i>Bob</i> and <i>Alice</i>,
            both using the same scenario (or first message, lorebook, etc) - you
            can edit that scenario once and both <i>Bob</i> and <i>Alice</i>{" "}
        ...
        <Accordion.Item className={classes.item} value="2">
          <Accordion.Control>
            <b>Can I use Faraday and Doghouse at the same time?</b>
          </Accordion.Control>
          <Accordion.Panel>
        ...
        <Accordion.Item className={classes.item} value="3">
          ...
          <Accordion.Panel>
            All the information is loaded directly from the local Faraday
            database
          </Accordion.Panel>
        </Accordion.Item>
        ...
        <Accordion.Item className={classes.item} value="4">
          ...
          <Accordion.Panel>
            No, it only requires Faraday to be installed on the same computer
          </Accordion.Panel>
        </Accordion.Item>
        ...
        <Accordion.Item className={classes.item} value="6">
          ...
          <Accordion.Panel>
            No, Doghouse is not storing data, it uses faraday database as the
            source of truth
          </Accordion.Panel>
        </Accordion.Item>
        ...
        <Accordion.Item className={classes.item} value="7">
          ...
          <Accordion.Panel>
            Everything is saved back to Faraday database
          </Accordion.Panel>
        </Accordion.Item>
